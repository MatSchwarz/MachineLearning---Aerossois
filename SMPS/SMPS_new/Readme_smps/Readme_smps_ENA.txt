Global attributes:
	...
	Size_range (min-max): 11-496 nm
	Additional_instruments: Condensation Particle Counter; Nephelometer; Aerosol Chemical Speciation Monitor
	Station_ID: ENA
	Location: Azores, Portugal (Eastern North Atlantic)
	Site_type: Marine
	Station_Latitude: 39.09 N
	Station_Longitude: 28.02 W
	Station_Altitude: 30 masl
	Time_Coordinate: UTC
	Time_Stamp_Info: yyyy-mm-dd hh:mm:ss
	Time_resolution: 5-min/1-h
	Data_Info: Particle number size distribution. Generated from DOE file: enaaossmpsC1.b1.[timestamp].nc
