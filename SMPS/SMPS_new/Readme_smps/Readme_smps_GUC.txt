Global attributes:
	...
	Size_range (min-max): 13-496/514 nm
	Additional_instruments: Condensation Particle Counter; Nephelometer; Aerosol Chemical Speciation Monitor
	Station_ID: GUC
	Location: Colorado, USA (SAIL)
	Site_type: Continental/Mountain
	Station_Latitude: 38.90 N
	Station_Longitude: 106.94 W
	Station_Altitude: 3137 masl
	Time_Coordinate: UTC
	Time_Stamp_Info: yyyy-mm-dd hh:mm:ss
	Time_resolution: 5-min/1-h
	Data_Info: Particle number size distribution. Generated from DOE file: gucaossmpsS2.b1.[timestamp].nc
