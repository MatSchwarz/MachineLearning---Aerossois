Global attributes:
	...
	Size_range (min-max): 11/22-461 nm
	Additional_instruments: Condensation Particle Counter; Nephelometer; Aerosol Chemical Speciation Monitor
	Station_ID: ASI
	Location: Ascension Island (LASIC)
	Site_type: Marine
	Station_Latitude: 7.97 S
	Station_Longitude: 14.35 W
	Station_Altitude: 314 masl
	Time_Coordinate: UTC
	Time_Stamp_Info: yyyy-mm-dd hh:mm:ss
	Time_resolution: 5-min/1-h
	Data_Info: Particle number size distribution. Generated from DOE file: asiaossmpsM1.b1.[timestamp].nc
