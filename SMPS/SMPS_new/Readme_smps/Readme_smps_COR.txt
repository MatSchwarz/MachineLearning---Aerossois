Global attributes:
	...
	Size_range (min-max): 11-461 nm
	Additional_instruments: Condensation Particle Counter; Nephelometer; Aerosol Chemical Speciation Monitor
	Station_ID: COR
	Location: Cordoba, Argentina (CACTI)
	Site_type: Continental
	Station_Latitude: 32.13 S
	Station_Longitude:  64.73 W
	Station_Altitude: 1141 masl
	Time_Coordinate: UTC
	Time_Stamp_Info: yyyy-mm-dd hh:mm:ss
	Time_resolution: 5-min/1-h
	Data_Info: Particle number size distribution. Generated from DOE file: coraossmpsM1.b1.[timestamp].nc
