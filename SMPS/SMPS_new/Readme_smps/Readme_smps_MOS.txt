Global attributes:
	...
	Size_range (min-max): 10-496/514 nm
	...
	Station_Latitude: variable (see locations related data set)
	Station_Longitude: variable (see locations related data set)
	Station_Altitude: 12 masl
	Time_Coordinate: UTC
	Time_Stamp_Info: yyyy-mm-dd hh:mm:ss
	Time_resolution: 5-min/1-h
	Data_Info: Particle number size distribution. Generated from DOE file: mosaossmpsM1.b1.[timestamp].nc
