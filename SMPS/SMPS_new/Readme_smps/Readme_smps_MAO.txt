Global attributes:
	...
	Size_range (min-max): 10/13-461 nm
	Additional_instruments: Condensation Particle Counter; Nephelometer; Aerosol Chemical Speciation Monitor
	Station_ID: MAO
	Location: Manacapuro, Brazil (GoAMAZON)
	Site_type: Continental/Urban
	Station_Latitude: 3.21 S
	Station_Longitude: 60.60 W
	Station_Altitude: 50 masl
	Time_Coordinate: UTC
	Time_Stamp_Info: yyyy-mm-dd hh:mm:ss
	Time_resolution: 5-min/1-h
	Data_Info: Particle number size distribution. Generated from DOE file: maoaossmpsS1.b1.[timestamp].nc
